- dashboard: creative_label_analysis
  ...
  - title: MIN ROAS Comparison between creatives with/without certain labels
    ...
    width: 12
    height: 7
  - title: Label Importance based on XGBoost Regressor Model
    name: Label Importance based on XGBoost Regressor Model
    model: aftership_user_demo
    explore: label_importance
    type: looker_column
    fields: [label_importance.feature, label_importance.max_importance_weight]
    sorts: [label_importance.max_importance_weight desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
